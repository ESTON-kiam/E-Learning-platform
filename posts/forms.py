from email import message as email_message  # Renaming to avoid conflicts
...
from .models import  Post, MainCourse, Curriculam, features, timing, Category, Customer, video, faq, subcat, blog, blankpage, tcforblog, Reviews, Cart, offers
