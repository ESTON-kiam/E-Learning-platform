...
class subcat(models.Model):
    parent = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='subcat', blank=True, null=True,
...
class Post(models.Model):
    ...
    subcategory = models.ForeignKey(subcat, on_delete=models.CASCADE, default=1, related_name="subcat", blank=True,
                                    null=True)
...
class tcforblog(models.Model):
    title = models.CharField(max_length=500)
    blank_page = models.ForeignKey(blankpage, on_delete=models.CASCADE, related_name='tc_blank_page', blank=True,
                                   null=True)
    content = RichTextField(blank=True, null=True)
